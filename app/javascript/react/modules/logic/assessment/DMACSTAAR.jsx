...
export default class DMACSTAAR extends Component {
  constructor(props) {
    super(props)
      ...
      <div>
        ...
        <div className='row'>
          <VJSChart
            ...
            reportPath  = '/public/VJS/ss_ui/assessment/dmac/staar/student_detail'
          ...
          >
            <VJSICSelect
              ...
              placeholder   = 'Year'
              width         = {100}
              params        = {{ dataset: ['dmac_staar_view'] }}
            />
          </VJSChart>
        </div>
      </div>
