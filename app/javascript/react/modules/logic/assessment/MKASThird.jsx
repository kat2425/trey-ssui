...
export default class MKASThird extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    return (
      <div>
        ...
        <div className='row'>
          <VJSChart
            id          = 'mkasthird-student-detail'
            reportPath  = '/public/VJS/ss_ui/assessment/mkas/third/student_detail'
