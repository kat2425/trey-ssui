...
export default class ESGI extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    return (
      <div>
        ...
        <div className='row'>
          <VJSChart
            id          = 'esgi-student-detail'
            reportPath  = '/public/VJS/ss_ui/assessment/esgi/student_detail'
