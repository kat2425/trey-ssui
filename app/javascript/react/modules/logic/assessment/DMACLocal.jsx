...
export default class DMACLocal extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    return (
      <div>
        ...
        <div className='row'>
          <VJSChart
            id          = 'dmac-staar-student-detail'
            reportPath  = '/public/VJS/ss_ui/assessment/dmac/local/student_detail'
            params      = {this.state.params}
            title       = 'Local Assessments'
            className   = 'col-md-12'
            isTable     = {true}
            linkOptions = {{
              events: {
