...
export default class LASLinks extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    return (
      <div>
        ...
        <div className='row'>
          <VJSChart
            id          = 'las-links-student-detail'
            reportPath  = '/public/VJS/ss_ui/assessment/las_links/student_detail'
