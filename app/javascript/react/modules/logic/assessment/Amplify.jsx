...
export default class Amplify extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    return (
      <div>
        ...
        <div className='row'>
          <VJSChart
            id          = 'amplify-student-detail'
            reportPath  = '/public/VJS/ss_ui/assessment/amplify/student_detail'
          ...
          >
            <VJSICSelect
              ...
              placeholder   = 'Year'
              width         = {100}
              params        = {{ dataset: ['vw_amplify_dibels_next'] }}
            />
          </VJSChart>
        </div>
      </div>
