...
export default class SATP extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    return (
      <div>
        ...
        <div className='row'>
          <VJSChart
            id          = 'satp-student-detail'
            reportPath  = '/public/VJS/ss_ui/assessment/satp/student_detail'
