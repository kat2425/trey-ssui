...
export default class Scantron extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    return (
      <div>
        ...
        <div className='row'>
          <VJSChart
            id          = 'scantron-student-detail'
            reportPath  = '/public/VJS/ss_ui/assessment/scantron/student_detail'
