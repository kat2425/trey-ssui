...
export default class PARCC extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    return (
      <div>
        ...
        <div className='row'>
          <VJSChart
            id          = 'parcc-student-detail'
            reportPath  = '/public/VJS/ss_ui/assessment/parcc/student_detail'
