...
export default class AIMSWeb extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    return (
      <div>
        ...
        <div className='row'>
          <VJSChart
            id          = 'aimsweb-student-detail'
            reportPath  = '/public/VJS/ss_ui/assessment/aimsweb/student_detail'
