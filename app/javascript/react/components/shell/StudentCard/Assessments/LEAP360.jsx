...
@observer
export default class LEAP360 extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    return (
      <div>
        <VJSChart
          id               = 'sc-leap360'
          reportPath       = '/public/VJS/ss_ui/assessment/leap_360/student_card'
          scale            = 'container'
          title            = 'LEAP360'
          isTable          = {true}
        ...
        >
          <VJSICSelect
            ...
            placeholder   = 'Year'
            width         = {100}
            params        = {{ dataset: ['vw_leap_360'], student_id: [student.id] }}
          />
        </VJSChart>
      </div>
    )
