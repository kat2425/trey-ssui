...
export default class ACTAspireInterim extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <VJSChart
          id               = 'sc-actaspireinterim'
          reportPath       = '/public/VJS/ss_ui/assessment/act_aspire_interim/student_card'
          scale            = 'container'
        ...
        >
          <VJSICSelect
            ...
            placeholder   = 'Year'
            width         = {100}
            params        = {{ dataset: ['vw_act_aspire_interim'], student_id: [student.id] }}
          />
        </VJSChart>
      </div>
    )
