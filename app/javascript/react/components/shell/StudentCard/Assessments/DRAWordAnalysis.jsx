...
@observer
export default class DRAWordAnalysis extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    return (
      <div>
        <VJSChart
          id               = 'sc-dra-wa'
          reportPath       = '/public/VJS/ss_ui/assessment/dra_word_analysis/student_card'
          scale            = 'container'
          title            = 'DRA Word Analysis'
          isTable          = {true}
        ...
        >
          <VJSICSelect
            ...
            placeholder   = 'Year'
            width         = {100}
            params        = {{ dataset: ['dra_word_analysis'], student_id: [student.id] }}
          />
        </VJSChart>
      </div>
    )
