...
@observer
export default class DIBELS extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    return (
      <div>
        <VJSChart
          id               = 'sc-dibels'
          reportPath       = '/public/VJS/ss_ui/assessment/dibels/student_card'
          scale            = 'container'
          title            = 'DIBELS'
          isTable          = {true}
        ...
        >
          <VJSICSelect
            ...
            placeholder   = 'Year'
            width         = {100}
            params        = {{ dataset: ['vw_standard_dibels'], student_id: [student.id] }}
          />
        </VJSChart>
      </div>
    )
